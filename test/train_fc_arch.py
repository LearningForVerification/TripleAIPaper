...
def train_and_log(arch, device, lambda_l1, global_log, patience=5, max_epochs=300):
    ...
    torch.onnx.export(model, dummy_input, f"model_{hidden_dim}.onnx", input_names=["input"], output_names=["output"], opset_version=11)
