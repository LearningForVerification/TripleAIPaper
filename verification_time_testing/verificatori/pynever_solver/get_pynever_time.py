...
def sslp_verify_single_worker(model_file: str, property_file: str, timeout: int, return_dict):
    try:
        nn_path = os.path.abspath(model_file)
        prop_path = os.path.abspath(property_file)
...
if __name__ == "__main__":
    model_path = r"/mnt/c/Users/andr3/PycharmProjects/TripleAIPaper/verification_time_testing/verificatori/pynever_solver/networks/CONV/over_param/flatten/conv_5.onnx"
    property_path = r"/mnt/c/Users/andr3/PycharmProjects/TripleAIPaper/verification_time_testing/verificatori/pynever_solver/properties/0.03/sample_0000_label_7_eps_0.030.vnnlib"
